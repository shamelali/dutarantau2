...
import { users, suggestions, suggestionUpvotes, suggestionComments, events, eventRsvps, jobsMarketplace, consularGuides, emergencyAlerts } from "./schema";
  ...
  try {
    ...
    const seededSuggestions = await db.insert(suggestions).values([
      ...
      },
      {
        ...
        description: "Mari kita buat direktori interaktif warung makan, katering, dan toko kelontong yang menjual bumbu dapur khas Indonesia (terasi, daun jeruk, rempah asli) di seluruh negeri jiran agar mempermudah diaspora dan UMKM Indonesia.",
    ...
    await db.insert(events).values([
      ...
      {
        title: "Webinar: Pemutihan Permit Kerja & Legalitas WNI di Malaysia",
    ...
    // 4. Seed Jobs & Marketplace
    await db.insert(jobsMarketplace).values([
      {
        title: "Dicari Chef / Juru Masak Masakan Padang Otentik",
        type: "job",
        category: "Culinary / Hospitality",
        priceOrSalary: "RM 3,200 - RM 4,000 / bulan",
      ...
      },
      {
        ...
        priceOrSalary: "RM 650 / bulan (Inc. Utilities)",
      ...
      },
      {
        ...
        priceOrSalary: "Sesuai berat barang (Start RM 15/kg)",
